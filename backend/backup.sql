...
CREATE TABLE `fund_manager_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `fund_id` (`fund_id`),
  CONSTRAINT `fund_manager_info_ibfk_1` FOREIGN KEY (`fund_id`) REFERENCES `funding_opportunities` (`id`)
...
INSERT INTO `fund_manager_info` VALUES (1,1,8851581.00);
...
INSERT INTO `funding_applications` VALUES (1,1,'Approved','user2'),(2,2,'Approved','user3'),(3,3,'pending','user2'),(4,1,'Approved','user2'),(5,1,'Approved','user2'),(6,1,'Approved','user2'),(7,2,'Pending','user_2fqNqCrOjTPi4plyROeE98P69NX'),(8,3,'Rejected','user_2fqNqCrOjTPi4plyROeE98P69NX'),(9,3,'Approved','user_2flejTji7TX3uLDvK2ALSOf2XAI');
...
-- Dump completed on 2024-05-18  0:06:51
